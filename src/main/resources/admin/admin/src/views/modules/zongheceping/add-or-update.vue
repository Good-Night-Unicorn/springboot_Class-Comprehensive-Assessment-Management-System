<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="德育" prop="deyu">
          <el-input v-model="ruleForm.deyu" 
              placeholder="德育" clearable  :readonly="ro.deyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="德育" prop="deyu">
              <el-input v-model="ruleForm.deyu" 
                placeholder="德育" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="智育" prop="zhiyu">
          <el-input v-model="ruleForm.zhiyu" 
              placeholder="智育" clearable  :readonly="ro.zhiyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="智育" prop="zhiyu">
              <el-input v-model="ruleForm.zhiyu" 
                placeholder="智育" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体育" prop="tiyu">
          <el-input v-model="ruleForm.tiyu" 
              placeholder="体育" clearable  :readonly="ro.tiyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体育" prop="tiyu">
              <el-input v-model="ruleForm.tiyu" 
                placeholder="体育" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="综合成绩" prop="zonghechengji">
            <el-input v-model="zonghechengji"
                placeholder="综合成绩" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zonghechengji" label="综合成绩" prop="zonghechengji">
...
export default {
  data() {
	...
	lurushijian : false,
      ...
      rules: {
          ...
          deyu: [
                { required: true, message: '德育不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          zhiyu: [
                { required: true, message: '智育不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          tiyu: [
  ...
  computed: {
    zonghechengji: {
      get: function () {
        return 0+parseFloat(this.ruleForm.deyu==""?0:this.ruleForm.deyu)+parseFloat(this.ruleForm.zhiyu==""?0:this.ruleForm.zhiyu)+parseFloat(this.ruleForm.tiyu==""?0:this.ruleForm.tiyu) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    // 提交
    onSubmit() {
        this.ruleForm.zonghechengji = this.zonghechengji
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zongheceping/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zonghecepingCrossAddOrUpdateFlag = false;
						 this.parent.search();
